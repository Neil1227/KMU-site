...
<section id="about" class="py-5 about-section">
    ...
    <div class="about-section py-5" data-aos="fade-up">
        <div class="container text-center">
            ...
            <div class="about-content d-flex flex-column flex-md-row align-items-center text-start gap-4 mb-5" data-aos="fade-right">
                <img src="{{ asset('assets/img/about/Logo (1).png') }}" alt="Riet Logo" class="about-logo" style="max-width: 120px; height: auto;">
                <p class="subtitle m-0" data-aos="fade-left" data-aos-delay="200">
                    The <strong> Research, Innovation, Extension, and Training</strong> <em>(RIET)</em> office committed in delivering impact-driven research, innovation, extension, and training 
            ...
            <div class="mission-box p-4 rounded" data-aos="zoom-in">
                ...
                <p class="text-white mb-0">
                    We aim to attain our mission in creating empowered communities through relevant and impact-driven research, extension, and training services for Food security, Climate Resiliency, and Poverty Alleviation.
                    This year, we have set institutional reforms to attract external funding, accelerate the development of research facilities, increase production of impact-driven data, innovative methods and technologies, publications and patents, leverage by establishing 
    ...
    <div class="team-section">
        <div class="team-container">
            ...
            <div class="team-card active special-layout" data-aos="fade-right">
                ...
                <div class="team-info">
                    <h4 class="highlight">Dr. Anita G. David Ph.D.</h4>
                    <p class="role">SUC President IV — PSAU President</p>
                    <p class="desc">
                        Leads PSAU with a vision of excellence, innovation, and compassion. She is committed <br> to advancing quality education, research, and community engagement, <br>fostering a 
            ...
            <div class="team-card special-layout" data-aos="fade-left">
                ...
                <div class="team-info">
                    <h4 class="highlight">Dr. Geraldine C. Sanchez Ph.D.</h4>
                ...
                <div class="card-section" data-aos="fade-up">
                    ...
                    <div class="card-pair">
                        <div class="team-card active" data-aos="fade-right">
                            <img src="{{ asset('assets/img/about/Carandang, Rogelio Jr. P. (Coat).png') }}" alt="">
                            <h4 class="highlight">Dr. Rogelio D. Carandang, Jr. PH.D.</h4>
            ...
            <div class="bottom-row">
                ...
                <div class="team-card" data-aos="fade-left">
                    <img src="{{ asset('assets/img/about/logo.png') }}" alt="Marie Jay Dayrit">
