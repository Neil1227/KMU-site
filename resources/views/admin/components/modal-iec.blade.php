        ...
        <form id="editIECForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="upload-box drop-area" data-type="file">
                                ...
                                <input type="file" name="file" id="edit_iec_file" class="file-input"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="upload-box drop-area" data-type="png">
                                ...
                                <input type="file" name="png" id="edit_iec_png" class="file-input" accept="image"
                                    hidden>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="submit" id="saveEditBtn" class="btn btn-success w-100">Update Material</button>
                </div>
            </div>
        </form>
    </div>
