...
<style>
    td.details-toggle { cursor: pointer; }
    .arrow-icon { margin-right: 6px; transition: transform 0.2s ease; }
    tr.shown .arrow-icon { transform: rotate(90deg); }
        ...
        <div class="card-body table-responsive-sm">
            <table id="thesisTable" class="table table-bordered table-striped table-sm align-middle nowrap">
                ...
                <tbody>
                    ...
                    @php
                        $graduation = $thesis->graduation_month && $thesis->graduation_year
                            ? \Carbon\Carbon::create()->month($thesis->graduation_month)->format('F') . ' ' . $thesis->graduation_year
                            : '—';
                    @endphp
                    <tr data-id="{{ $thesis->id }}">
                        ...
                        <td class="details-toggle"
                            data-title="{{ $thesis->thesis_title ?? '—' }}"
...
<td class="text-center">
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            @if ($thesis->file_path)
            <li>
                <a class="dropdown-item text-warning" href="{{ asset('storage/' . $thesis->file_path) }}" target="_blank">
            ...
            <li>
                <a class="dropdown-item text-primary" href="{{ $thesis->googledrive_link }}" target="_blank">
            ...
            <li>
                <button class="dropdown-item text-success" onclick="editThesis({{ $thesis->id }})">
                    <i class="bi bi-pencil me-2"></i>Edit
                </button>
            </li>

            <li>
                <button class="dropdown-item text-danger" onclick="deleteThesis({{ $thesis->id }})">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" name="graduation_month" id="editMonth" min="1" max="12">
                        </div>
                        <div class="col-md-6">
                            <label>Graduation Year</label>
                            <input type="number" class="form-control" name="graduation_year" id="editYear" min="1900" max="2100">
                        </div>
                    </div>
