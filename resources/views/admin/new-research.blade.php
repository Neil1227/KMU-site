...
@section('content')
    <div class="container mt-4">
        <div class="card mt-4">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @if ($research->status === 'pending')
                                        <form
                                            action="{{ route('admin.new-research.acknowledge', ['id' => $research->id]) }}"
                                            method="POST" class="d-inline acknowledge-form">
                                            @csrf
                                            <button type="submit" class="btn btn-sm btn-warning"
                                                title="Acknowledge this research" data-id="{{ $research->id }}">
                                    ...
                                    @else
                                        ...
                                        <button class="btn btn-sm btn-success push-to-extension"
                                            data-id="{{ $research->id }}" title="Push to Extension"
                                            @if (session('admin_role') !== 'KMU') disabled @endif>
                                            <i class="bi bi-box"></i>
                                        </button>

                                        <button class="btn btn-sm btn-danger delete-research" data-id="{{ $research->id }}"
                                            title="Delete Research" @if (session('admin_role') !== 'KMU') disabled @endif>
            ...
            <!-- Push to IPTBM Modal -->
            <div class="modal fade" id="pushToIptbmModal" tabindex="-1" aria-labelledby="pushToIptbmLabel"
                aria-hidden="true">
                    ...
                    <div class="modal-content">
                        <form id="pushToIptbmForm">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="pushToIptbmLabel">Push Research to IPTBM (For Commercialization)
                                </h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="type_of_technology" id="type_of_technology" class="form-select"
                                            required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="technology_generator"
                                            id="technology_generator" required>
                                    </div>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header bg-success text-white">
                            <h5 class="modal-title text-white" id="addResearchModalLabel"><i
                                    class="bi bi-flask me-2"></i>Add New Research</h5>
                        ...
                        <form action="{{ route('admin.add-thesis.storetokmu') }}" method="POST">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="technology_type" id="technology_type"
                                        class="form-control" placeholder="Enter type of technology" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" name="link" id="link" class="form-control"
                                        placeholder="Optional: enter research link (e.g., Google Drive)">
                                </div>
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.push-to-iptbm-btn').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    document.getElementById('type_of_technology').value = this.dataset
                        .technology_type;
