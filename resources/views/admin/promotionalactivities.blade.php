...
@section('title', 'Upload Promotional Activity')

@section('content')

<!-- Promotional Activity Form and Quick Actions Side-by-Side -->
<div class="row g-4">
    ...
    <div class="col-md-6">
        <div class="ictv-form mt-2">
            ...
            <form action="{{ route('admin.promotional.upload') }}" method="POST" enctype="multipart/form-data" data-show-loader>
                @csrf
