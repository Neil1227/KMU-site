...
<script>
    $(document).ready(function() {
        $('.table').DataTable({
            ...
            columns: [
                { responsivePriority: 1, className: "all" },  // Thesis Title
                { responsivePriority: 2, className: "all" },  // Technologies
                { className: "all" },                          // Tech Generator
                { className: "all" },                          // Contact Info
                { className: "all" },                          // Type of Technology
                { className: "all" },                          // IP Status
                { className: "none" },                         // TRL Level
                { className: "none" },                         // SDGs
                { responsivePriority: 3, className: "all" },   // Remarks
                { className: "all" },                          // Recommendations
                { className: "none" },                         // Link
                { className: "none" },                         // Priority Area
                { responsivePriority: 4, className: "all" }    // Actions
            ],
