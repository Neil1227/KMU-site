                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="upload-box">
                                        ...
                                        <p>Upload PDF file</p>
                                        <input type="file" id="modulues-pdf" name="modulues-pdf" accept="image/pdf" hidden onchange="this.previousElementSibling.previousElementSibling.innerHTML = this.files[0].name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="upload-box">
                                        <i class="fa fa-upload upload-icon"></i>
                                        <p>Upload PNG file</p>
                                        <input type="file" id="modules-png" name="modules-png" accept="image/png" hidden onchange="this.previousElementSibling.previousElementSibling.innerHTML = this.files[0].name">
                                    </div>
                                </div>
                            </div>
