...
@section('title', 'Upload Podcast Episode')

@section('content')

<!-- Podcast Form and Quick Actions Side-by-Side -->
<div class="row g-4">
    ...
    <div class="col-md-6">
        <div class="ictv-form mt-2">
            ...
            <form action="{{ route('admin.podcast.store') }}" method="POST" enctype="multipart/form-data" data-show-loader>
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <div class="upload-box drop-area" data-type="png">
                        ...
                        <input type="file" id="thumbnail" name="png" accept="image/png" class="file-input" required hidden>
                    </div>
                </div>
