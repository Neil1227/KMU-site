    ...
    <div class="container-fluid d-flex justify-content-evenly ">
        ...
        <div class="collapse navbar-collapse justify-content-evenly" id="navbarNav">
            ...
            <ul class="navbar-nav ">
                ...
                <li class="nav-item"><a class="nav-link text-white" href="{{ route('homepage') }}#media-resources">Media
                        Resources</a></li>
                <li class="nav-item"><a class="nav-link text-white" href="{{ route('homepage') }}#research">Research</a>
                </li>
                ...
                <li class="nav-item dropdown dropdown-hover">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                            <a class="dropdown-item text-dark" href="#">Intellectual Property Unit</a>
                            <ul class="dropdown-menu submenu">
