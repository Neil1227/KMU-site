  ...
  <div class="heading" data-aos="fade-down" data-aos-duration="1000">
    <ul class="heading-list mt-1">
      ...
      <li class="heading-content-social">
        ...
        <a href="https://www.youtube.com/@KnowledgeManagementUnit" target="_blank" class="social-icon"><i class="fa-brands fa-youtube"></i></a>
        <a href="https://www.tiktok.com/@psaukmu?_t=ZS-8xqn6EGt5E7&_r=1" target="_blank" class="social-icon"><i class="fa-brands fa-tiktok"></i></a>
