...
@section('content')
    ...
    <section class="container-page mt-3">
        ...
        <p class="text-muted text-center  mb-3"><em>Follow these 4 simple steps to get your anti-plagiarism
                certificate.</em></p>
        ...
        <div class="steps-container mb-5">
                ...
                <div class="qr-box mt-3 p-3">
                    <div class="qr-grid">
                        ...
                        <div class="qr-content">
                            ...
                            <a href="https://docs.google.com/forms/d/e/1FAIpQLSfMYKBGAQRT-RNDej52Xzu7qGVn94pcs9P-_CkxBTRyDYONaQ/viewform?pli=1"
                                target="_blank" class="btn-qr btn-sm text-decoration-none">Open Form</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="step-card secondary">
                ...
                <p class="desc">
                    Expect an email from the Knowledge Management Center regarding the similarity index, status of your
                    paper, and your overall score.
                </p>
            </div>

            <!-- Step 3 -->
            <div class="step-card tertiary">
                <div class="step-icon-wrap">
                    <div class="step-icon">
                ...
                <p class="desc">
                    If the paper passes the criteria, you’ll be asked to pick up your anti-plagiarism certificate.
                    Otherwise, you’ll receive feedback via email for revisions.
                </p>
            </div>
            ...
            <div class="step-card green">
                ...
                <p class="desc">
                    Visit ICTRD office beside CBEE building. <strong> Before we issue the Anti-Plagiarism Testing
                        Certificate, please pay fees at Cashier’s Office if applicable.</strong>
                </p>
