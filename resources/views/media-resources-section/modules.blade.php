...
@section('content')
    ...
    <div class="background-container">
        <picture>
            ...
            <img src="{{ asset('assets/img/logos-bg.png') }}" alt="Abstract Background" loading="lazy"
    ...
    <section class="container-page my-5">
        <div class="row g-4" id="moduleCards">
            @foreach ($modules as $index => $module)
                <div class="col-md-6 col-lg-4 module-card {{ $index >= 6 ? 'd-none' : '' }}">

                    <a href="{{ asset('storage/modules/' . $module->file) }}" target="_blank" class="text-decoration-none">
                        <div class="pdf-card">
                            <img src="{{ asset('storage/modules_thumbnail/' . $module->png) }}" alt="{{ $module->title }}"
