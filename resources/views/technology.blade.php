        ...
        <div class="container-page my-5">
                ...
                <div class="col-md-6 d-flex flex-column">
                    ...
                    <div class="d-none d-md-flex align-items-center gap-3 mt-3">
                        ...
                        <button type="button"
                            ...
                            data-bs-toggle="modal" data-bs-target="#downloadModal" style="cursor: pointer;">
                ...
                <div class="col-md-6 d-flex flex-column align-items-center">
                    <div class="image-card p-3 rounded-4 shadow-lg bg-white mb-3">
                        @php
                            $imagePath =
                                $technology->image &&
                                file_exists(storage_path('app/public/technologies/' . $technology->image))
                                    ? asset('storage/technologies/' . $technology->image)
                                    : asset('assets/img/kmlogo.png');
                        @endphp

                        <img src="{{ $imagePath }}" alt="{{ $technology->product ?? 'Technology' }}"
            ...
            <div class="row mb-5">
                @if (count($propositions))
                    <div class="col-md-6">
                        <h5 class="fw-bold tech-title"><i class="bi bi-graph-up-arrow me-2 icon-colored"></i> Product
                            Propositions</h5>
                ...
                @if (count($benefits))
                    <div class="col-md-6">
                        <h5 class="fw-bold tech-title"><i class="bi bi-people-fill me-2 icon-colored"></i> Consumer Benefits
                        </h5>
                        <ul class="mt-3 text-muted">
